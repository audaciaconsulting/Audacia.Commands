...
{
    /// <summary>
    /// Extensions to <see cref="IValidationModel{TModel}"/>.
    /// </summary>
    public static class ValidationModelExtensions
    {
        ...
        public static IValidationModel<TModel> AlreadyExists<TModel, TProperty>(
            this IValidationModel<TModel> model,
        ...
        /// <returns>the validation model.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="model"/> is <see langword="null"/>.</exception>
        public static IValidationModel<TModel> IsRequired<TModel, TProperty>(
            this IValidationModel<TModel> model,
            Expression<Func<TModel, TProperty>> property,
            string? displayName = null)
            where TModel : class
        ...
        /// <returns>The validation model.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="model"/> is <see langword="null"/>.</exception>
        public static IValidationModel<TModel> HasMaxLength<TModel>(
            this IValidationModel<TModel> model,
        ...
        /// <returns>The validation model.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="model"/> is <see langword="null"/>.</exception>
        public static IValidationModel<TModel> HasMaxLength<TModel, TProperty>(
            this IValidationModel<TModel> model,
        ...
        /// <returns>The validation model.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="model"/> is <see langword="null"/>.</exception>
        public static IValidationModel<TModel> HasMinLength<TModel>(
            this IValidationModel<TModel> model,
            Expression<Func<TModel, string>> property,
            int length,
            string? displayName = null)
        ...
        /// <returns>The validation model.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="model"/> is <see langword="null"/>.</exception>
        public static IValidationModel<TModel> HasMinLength<TModel, TProperty>(
            this IValidationModel<TModel> model,
            Expression<Func<TModel, IEnumerable<TProperty>>> property,
            int length,
            string? displayName = null)
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Roslynator", "RCS1164:Unused type parameter.", Justification = "Part of a public API.")]
        public static IValidationModel<TModel> MatchesPattern<TModel, TProperty>(
            this IValidationModel<TModel> model,
            Expression<Func<TModel, string>> property,
            string pattern,
            string? displayName = null,
        ...
        /// <returns>The validation model.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="model"/> is <see langword="null"/>.</exception>
        public static IValidationModel<TModel> MustBeAValidId<TModel>(
            this IValidationModel<TModel> model,
            Expression<Func<TModel, int?>> property,
            string? displayName = null)
            where TModel : class
        {
            if (model == null) throw new ArgumentNullException(nameof(model));
        ...
        /// <returns>The validation model.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="model"/> is <see langword="null"/>.</exception>
        public static IValidationModel<TModel> MustBeGreaterThan<TModel, TProperty>(
            this IValidationModel<TModel> model,
            Expression<Func<TModel, TProperty>> property,
            TProperty number,
            string? displayName = null)
        ...
        /// <returns>The validation model.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="model"/> is <see langword="null"/>.</exception>
        public static IValidationModel<TModel> MustBeGreaterThanOrEqualTo<TModel, TProperty>(
            this IValidationModel<TModel> model,
            Expression<Func<TModel, TProperty>> property,
            TProperty number,
            string? displayName = null)
        ...
        /// <returns>The validation model.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="model"/> is <see langword="null"/>.</exception>
        public static IValidationModel<TModel> MustBeLessThan<TModel, TProperty>(
            this IValidationModel<TModel> model,
            Expression<Func<TModel, TProperty>> property,
            TProperty number,
            string? displayName = null)
        ...
        /// <returns>The validation model.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="model"/> is <see langword="null"/>.</exception>
        public static IValidationModel<TModel> MustBeLessThanOrEqualTo<TModel, TProperty>(
            this IValidationModel<TModel> model,
            Expression<Func<TModel, TProperty>> property,
            TProperty number,
            string? displayName = null)
